  ...
  <div class="scrollbar-inner">
      ...
      <ul class="navigation">
        <li class="{{ Request::is('home') ? 'navigation__active' : '' }}"><a href="{{url('home')}}"><i class="zmdi zmdi-home"></i> Beranda</a></li>
          ...
          <li class="{{ Request::is('pengunjung') ? 'navigation__active' : '' }}"><a href="{{url('pengunjung')}}"><i class="zmdi zmdi-assignment-check"></i>Pengunujung</a></li>
          ...
          <ul>
            ...
            <li class="{{ Request::is('export/pengembalian') ? 'navigation__active' : '' }}"><a href="{{url('export/pengembalian')}}">Laporan Pengembalian Buku</a></li>

            <li class="{{ Request::is('export/pengunjung') ? 'navigation__active' : '' }}"><a href="{{url('export/pengunjung')}}">Laporan Pengunjung Perpustakaan</a></li>
          </ul>   
        </li>
      </ul>
    </div>
