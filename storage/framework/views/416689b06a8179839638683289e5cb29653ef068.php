  ...
  <div class="scrollbar-inner">
      ...
      <ul class="navigation">
        <li class="<?php echo e(Request::is('home') ? 'navigation__active' : ''); ?>"><a href="<?php echo e(url('home')); ?>"><i class="zmdi zmdi-home"></i> Beranda</a></li>
          ...
          <li class="<?php echo e(Request::is('pengunjung') ? 'navigation__active' : ''); ?>"><a href="<?php echo e(url('pengunjung')); ?>"><i class="zmdi zmdi-assignment-check"></i>Pengunujung</a></li>

          <?php

          $active_parent_1 =Request::is('export/peminjaman') || 
                            Request::is('export/pengembalian') ||
                            Request::is('export/pengunjung') ? 'navigation__sub--active' : ''; 
          ?>

          <li class="navigation__sub <?php echo e($active_parent_1); ?> navigation__sub--toggled">
          <a href="#"><i class="zmdi zmdi-download"></i> Export</a>
          <ul>
            ...
            <li class="<?php echo e(Request::is('export/pengembalian') ? 'navigation__active' : ''); ?>"><a href="<?php echo e(url('export/pengembalian')); ?>">Laporan Pengembalian Buku</a></li>

            <li class="<?php echo e(Request::is('export/pengunjung') ? 'navigation__active' : ''); ?>"><a href="<?php echo e(url('export/pengunjung')); ?>">Laporan Pengunjung Perpustakaan</a></li>
          </ul>   
        </li>
      </ul>
    </div>
